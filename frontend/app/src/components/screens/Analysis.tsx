...
import { negativeWord, negativeWordSm, positiveWord, positiveWordSm } from '~/config/words';
  ...
  return (
    <div className="bg-white min-h-screen p-6 text-gray-800 w-full">
      <div className="flex relative">
        ...
        <div className="group absolute left-[10rem]  md:relative md:top-0 md:left-0 md:pl-4">
          <CircleHelp />
          {/* SPでアイコンの下に表示、MD以上でアイコンの右に表示 */}
          <div
            className=" absolute top-full left-1/2 -translate-x-1/2 mt-2 w-[300px] // SPでの位置調整と最大幅設定
      ...
      <section className="my-24">
        <div className="flex relative">
          ...
          <div className="group absolute left-[5.4rem]  md:relative md:top-0 md:left-0 md:pl-4">
            <CircleHelp />
            {/* SPでアイコンの下に表示、MD以上でアイコンの右に表示 */}
            <div
              className="z-10 absolute top-full left-[100px] -translate-x-1/2 mt-2 w-[300px] // SPでの位置調整と最大幅設定
                    md:static md:top-auto md:left-auto md:translate-x-0 md:mt-0 md:ml-4 // MD以上での位置調整
                    bg-gray-700 text-white text-sm px-2 py-1 rounded whitespace-normal opacity-0 group-hover:opacity-100 transition pointer-events-none"
            >
      ...
      <section className="mt-48 ">
        ...
        <div className="flex justify-center w-full">
          <Words
            words={window.innerWidth < 640 ? positiveWordSm : positiveWord}
            size={window.innerWidth < 640 ? { width: 400, height: 500 } : { width: 400, height: 400 }}
          />
        </div>
      </section>
      <section className="mb-20 ">
        ...
        <div className="flex justify-center w-full">
          <Words
            words={window.innerWidth < 640 ? negativeWordSm : negativeWord}
            size={window.innerWidth < 640 ? { width: 400, height: 500 } : { width: 400, height: 400 }}
          />
        </div>
      </section>
