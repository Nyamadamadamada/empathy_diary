      ...
      <div className="max-w-4xl mx-auto p-6 space-y-8 w-full">
        ...
        <div className="flex items-start space-x-8 w-full animate-fade-fast">
          ...
          <div className="flex flex-col justify-center mt-2 zenMaru-regular leading-[1.8] text-xl ">
            ...
            <p className="opacity-0 animate-fade-fast delay-400 font-bold">最後に、年齢と性別を教えてね。</p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-3 mt-6 animate-fade-fast opacity-0 delay-500">
          ...
          <div className="mt-20">
            <TextWatchButton originalText="" label="設定を完了する" currentText={name} onClick={handleCheck} />
          </div>
        </div>
      </div>
    </div>
